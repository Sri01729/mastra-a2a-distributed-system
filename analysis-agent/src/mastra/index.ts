...
/**
 * Mastra Configuration - Analysis Agent Server
 *
 * This configuration:
 * 1. Registers our Analysis Agent with Mastra
 ...
 *    - Direct messaging for analysis requests
 *    - Task delegation for analytical work
 *    - Streaming responses for long-running analysis tasks
 *
 ...
 *    - Research Agent: Accept research data for analysis
 *    - Writing Agent: Provide analytical insights for reports
 *    - Gateway Agent: Accept analysis tasks from frontend requests
 *
 * 6. **Data Pipeline**: This agent completes the data processing pipeline:
 *    - Research Agent → Analysis Agent → Writing Agent
 *    - Raw data → Analysis → Insights → Reports
 */
